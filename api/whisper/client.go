...
import (
	...
	"github.com/Dbaker1298/voice-to-text-whisperAPI/models"
	"github.com/Dbaker1298/voice-to-text-whisperAPI/transcribe"
)
...
func (c *Client) Transcribe(h io.Reader, opts ...transcribe.TranscribeOption) (*models.TranscribeResponse, error) {
	...
	if resp.StatusCode != http.StatusOK {
		io.Copy(os.Stderr, r)
		return nil, fmt.Errorf("unexpected respondse: %s", resp.Status)
	}
